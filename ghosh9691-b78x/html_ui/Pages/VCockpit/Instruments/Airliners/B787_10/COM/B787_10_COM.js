...
class B787_10_Com_XPDR extends B787_10_Com_Page {
    ...
    show() {
        ...
        this.xpdr_mode = SimVar.GetSimVarValue("TRANSPONDER STATE:1", "Enum");
        this.setXpdrMode(this.xpdr_mode);
    }
    onEvent(_event) {
        super.onEvent(_event);
        switch (_event) {
            ...
            case "L3":
                ...
                if (this.xpdr_mode > 5)
                    this.xpdr_mode = 0;
                SimVar.SetSimVarValue("TRANSPONDER STATE:1", "Enum", this.xpdr_mode);
                this.setXpdrMode(this.xpdr_mode);
                break;
        }
    }
    ...
    setXpdrMode(mode) {
        switch (mode) {
            case 0:
                this.setHTML(this.l3, "<tspan style='fill:lime'>OFF</tspan>");
                break;
            case 1:
                this.setHTML(this.l3, "<tspan style='fill:lime'>STBY</tspan>");
                break;
            case 2:
                this.setHTML(this.l3, "<tspan style='fill:lime'>TST</tspan>");
                break;
            case 3:
                this.setHTML(this.l3, "<tspan style='fill:lime'>TA&#47;RA</tspan>");
                break;
            case 4:
                this.setHTML(this.l3, "<tspan style='fill:lime'>ALT</tspan>");
                break;
            case 5:
                this.setHTML(this.l3, "<tspan style='fill:lime'>TA</tspan>");
                break;
        }
    }
